...
app.post('/api/brainstorm', async (req, res) => {
  ...
  try {
    ...
    const sequence = [
      { provider: openaiProvider, speaker: 'openai' as const, speakerLabel: 'GPT-5.5', modelName: gptConfig.model, thinkingLevel: gptConfig.thinkingLevel, maxTokens: 380 },
      { provider: anthropicProvider, speaker: 'anthropic' as const, speakerLabel: 'Claude Opus', modelName: claudeConfig.model, thinkingLevel: claudeConfig.thinkingLevel, maxTokens: 380 },
    ]
